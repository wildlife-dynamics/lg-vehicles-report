...
def main(params: dict[str, Any], validate_params_schema: bool = True):
    ...
    format_speed_bin_labels = (
        ...
        .partial(
            ...
            new_unit="km/h",
            decimal_places=1,
            **(params.get("format_speed_bin_labels") or {}),
        )
    ...
    format_speed_values = (
        ...
        .partial(
            ...
            new_unit="km/h",
            decimal_places=1,
            **(params.get("format_speed_values") or {}),
        )
    ...
    zip_speed_with_viewstate = (
        task(groupbykey)
        .validate()
        .set_task_instance_id("zip_speed_with_viewstate")
        .handle_errors()
        .with_tracing()
        .skipif(
            conditions=[
        ...
        .partial(
            ...
            **(params.get("zip_speed_with_viewstate") or {}),
        )
        .call()
    )
    ...
    draw_speedmap = (
        ...
        .mapvalues(
            argnames=["geo_layers", "view_state"], argvalues=zip_speed_with_viewstate
        )
    )
    ...
    zip_track_layers_view = (
        ...
        .partial(
            ...
            **(params.get("zip_track_layers_view") or {}),
        )
        .call()
    )
    ...
    create_tracks_widgets = (
        ...
        .partial(title="Vehicle Tracks", **(params.get("create_tracks_widgets") or {}))
    ...
    merge_tracks_widgets = (
        ...
        .partial(
            widgets=create_tracks_widgets, **(params.get("merge_tracks_widgets") or {})
        )
        .call()
    )
    ...
    draw_speed_line_chart = (
        ...
        .partial(
            ...
            **(params.get("draw_speed_line_chart") or {}),
        )
    ...
    persist_vehicle_chart = (
        ...
        .partial(
            ...
            **(params.get("persist_vehicle_chart") or {}),
        )
    ...
    line_chart_widget = (
        ...
        .partial(
            title="Vehicle Speed Over Time", **(params.get("line_chart_widget") or {})
        )
    ...
    grouped_plot_widget_merge = (
        ...
        .partial(
            widgets=line_chart_widget, **(params.get("grouped_plot_widget_merge") or {})
        )
        .call()
    )
    ...
    convert_speed_png = (
        ...
        .partial(
            ...
            **(params.get("convert_speed_png") or {}),
        )
    ...
    convert_tracks_png = (
        ...
        .partial(
            ...
            **(params.get("convert_tracks_png") or {}),
        )
    ...
    convert_line_png = (
        ...
        .partial(
            ...
            **(params.get("convert_line_png") or {}),
        )
    ...
    persist_vehicles_page = (
        task(create_context_page)
        .validate()
        .set_task_instance_id("persist_vehicles_page")
        .handle_errors()
        .with_tracing()
        .skipif(
            conditions=[
        ...
        .partial(
            ...
            **(params.get("persist_vehicles_page") or {}),
        )
        .call()
    )
    ...
    build_vehicles_context = (
        task(create_vehicles_context)
        .validate()
        .set_task_instance_id("build_vehicles_context")
        .handle_errors()
        .with_tracing()
        .skipif(
            conditions=[
        ...
        .partial(**(params.get("build_vehicles_context") or {}))
        .mapvalues(
            argnames=["summary_table", "speedmap", "tracks_map", "line_chart"],
    ...
    create_grouper_doc = (
        ...
        .mapvalues(argnames=["context"], argvalues=build_vehicles_context)
    )
    ...
    merge_collared_docs = (
        ...
        .partial(
            cover_page_path=persist_vehicles_page,
            output_dir=os.environ["ECOSCOPE_WORKFLOWS_RESULTS"],
    ...
    vehicles_dashboard = (
        ...
        .partial(
            ...
            time_range=time_range,
            groupers=groupers,
            **(params.get("vehicles_dashboard") or {}),
        )
        .call()
    )
