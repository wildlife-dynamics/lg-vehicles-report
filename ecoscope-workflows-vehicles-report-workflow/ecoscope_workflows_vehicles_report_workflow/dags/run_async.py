...
def main(params: Params):
    ...
    dependencies = {
        ...
        "draw_speedmap": ["base_map_defs", "zip_speedmap_with_viewstate"],
        ...
        "zip_track_layers_view": ["combine_track_layers", "zoom_speed_gdf_extent"],
        "draw_track_map": ["base_map_defs", "zip_track_layers_view"],
        "track_html_url": ["draw_track_map"],
        "create_tracks_widgets": ["track_html_url"],
        "merge_tracks_widgets": ["create_tracks_widgets"],
        "draw_speed_line_chart": ["split_subject_traj_groups"],
        "persist_vehicle_chart": ["draw_speed_line_chart"],
        "line_chart_widget": ["persist_vehicle_chart"],
        "grouped_plot_widget_merge": ["line_chart_widget"],
        ...
        "convert_speed_png": ["zip_speed_value"],
        "zip_tracks_value": ["gdf_image_extent", "track_html_url"],
        "convert_tracks_png": ["zip_tracks_value"],
        "convert_line_png": ["persist_vehicle_chart"],
        "download_cover_page": [],
        ...
        "create_grouper_doc": ["download_sect_templates", "indv_cl_ctx"],
    ...
    nodes = {
        ...
        "create_tracks_widgets": Node(
            ...
            | (params_dict.get("create_tracks_widgets") or {}),
            method="map",
            kwargs={
                "argnames": ["view", "data"],
        ...
        "merge_tracks_widgets": Node(
            ...
            .set_executor("lithops"),
            partial={
                "widgets": DependsOn("create_tracks_widgets"),
            }
            | (params_dict.get("merge_tracks_widgets") or {}),
            method="call",
        ),
        "draw_speed_line_chart": Node(
        ...
        "persist_vehicle_chart": Node(
            ...
            kwargs={
                "argnames": ["text"],
                "argvalues": DependsOn("draw_speed_line_chart"),
            },
        ),
        "line_chart_widget": Node(
            ...
            kwargs={
                "argnames": ["view", "data"],
                "argvalues": DependsOn("persist_vehicle_chart"),
            },
        ),
        "grouped_plot_widget_merge": Node(
            async_task=merge_widget_views.validate()
            ...
            .set_executor("lithops"),
            partial={
                "widgets": DependsOn("line_chart_widget"),
            }
        ...
        "zip_tracks_value": Node(
            async_task=zip_groupbykey.validate()
            .set_task_instance_id("zip_tracks_value")
            .handle_errors()
            .with_tracing()
            .skipif(
                conditions=[
            ...
            partial={
                "sequences": [
                    DependsOn("gdf_image_extent"),
                    DependsOn("track_html_url"),
                ],
            }
            | (params_dict.get("zip_tracks_value") or {}),
            method="call",
        ),
        "convert_tracks_png": Node(
            async_task=adjust_map_zoom_and_screenshot.validate()
            ...
            kwargs={
                "argnames": ["view_state", "input_file"],
                "argvalues": DependsOn("zip_tracks_value"),
            },
        ),
        "convert_line_png": Node(
        ...
        "group_context_values": Node(
            ...
            partial={
                "sequences": [
                    ...
                    DependsOn("convert_tracks_png"),
                    DependsOn("convert_line_png"),
                ],
            }
        ...
        "indv_cl_ctx": Node(
            async_task=create_vehicles_grouper_ctx.validate()
        ...
        "vehicles_dashboard": Node(
            ...
            partial={
                ...
                "widgets": [
                    ...
                    DependsOn("merge_tracks_widgets"),
                    DependsOn("grouped_plot_widget_merge"),
                ],
                "time_range": DependsOn("time_range"),
                "groupers": DependsOn("groupers"),
            }
