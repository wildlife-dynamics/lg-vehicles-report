...
combine_track_layers_params = dict()
...
combine_track_layers = (
    combine_deckgl_map_layers.set_task_instance_id("combine_track_layers")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
...
zip_track_layers_view_params = dict()
...
zip_track_layers_view = (
    zip_groupbykey.set_task_instance_id("zip_track_layers_view")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
...
draw_track_map = (
    draw_map.set_task_instance_id("draw_track_map")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
    ...
    .partial(
        ...
        max_zoom=15,
        legend_style={"placement": "bottom-right"},
        **draw_track_map_params,
    )
    .mapvalues(argnames=["geo_layers", "view_state"], argvalues=zip_track_layers_view)
)


# %% [markdown]
# ## Persist tracks as text

# %%
# parameters

track_html_url_params = dict(
    filename=...,
)
...
track_html_url = (
    persist_text.set_task_instance_id("track_html_url")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
...
# %% [markdown]
# ## Create tracks widgets

# %%
# parameters

create_tracks_widgets_params = dict()
...
create_tracks_widgets = (
    create_map_widget_single_view.set_task_instance_id("create_tracks_widgets")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
    ...
    .partial(title="Vehicle Tracks", **create_tracks_widgets_params)
    .map(argnames=["view", "data"], argvalues=track_html_url)
)


# %% [markdown]
# ## Merge tracks widgets

# %%
# parameters

merge_tracks_widgets_params = dict()
...
merge_tracks_widgets = (
    merge_widget_views.set_task_instance_id("merge_tracks_widgets")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
    ...
    .partial(widgets=create_tracks_widgets, **merge_tracks_widgets_params)
    .call()
)


# %% [markdown]
# ## Draw vehicle line chart

# %%
# parameters

draw_speed_line_chart_params = dict(
    widget_id=...,
)
...
draw_speed_line_chart = (
    draw_line_chart.set_task_instance_id("draw_speed_line_chart")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
...
# %% [markdown]
# ## Persist line chart as text

# %%
# parameters

persist_vehicle_chart_params = dict(
    filename=...,
)
...
persist_vehicle_chart = (
    persist_text.set_task_instance_id("persist_vehicle_chart")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
...
# %% [markdown]
# ## Create Plot Widget for Line Chart

# %%
# parameters

line_chart_widget_params = dict()
...
line_chart_widget = (
    create_plot_widget_single_view.set_task_instance_id("line_chart_widget")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
    ...
    .partial(title="Vehicle Speed Over Time", **line_chart_widget_params)
    .map(argnames=["view", "data"], argvalues=persist_vehicle_chart)
)


# %% [markdown]
# ## Merge Plot Widget Views

# %%
# parameters

grouped_plot_widget_merge_params = dict()
...
grouped_plot_widget_merge = (
    merge_widget_views.set_task_instance_id("grouped_plot_widget_merge")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
    ...
    .partial(widgets=line_chart_widget, **grouped_plot_widget_merge_params)
    .call()
)
...
convert_tracks_png_params = dict()
...
# %% [markdown]
# ## Convert line chart to png

# %%
# parameters

convert_line_png_params = dict()
...
convert_line_png = (
    html_to_png.set_task_instance_id("convert_line_png")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
...
indv_cl_ctx = (
    create_vehicles_grouper_ctx.set_task_instance_id("indv_cl_ctx")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
...
vehicles_dashboard_params = dict(
    warning=...,
)
...
vehicles_dashboard = (
    gather_dashboard.set_task_instance_id("vehicles_dashboard")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
